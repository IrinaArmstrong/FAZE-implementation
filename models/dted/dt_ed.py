...
class DTED(nn.Module):
    ...
    def __init__(self, z_dim_app: int, z_dim_gaze: int, z_dim_head: int,
                 growth_rate: int = 32, activation_fn: nn.Module = nn.LeakyReLU,
                 normalization_fn: nn.Module = nn.InstanceNorm2d,
                 decoder_input_c=16,
